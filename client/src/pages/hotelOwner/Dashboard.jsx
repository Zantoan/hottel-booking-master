...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard' subTitle='Mornitor your
       room listings, track booking and analyze revenue-all in one place. Stay
       ...
       {/*------Recent Bookings----- */}
       <h2 className='text-xl text-blue-950/70 font-medium mb-5'>Recen Bookings</h2>
